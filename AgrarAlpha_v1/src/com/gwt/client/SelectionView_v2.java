...
public class SelectionView_v2 extends Composite implements Serializable{

	public static Label yearLabel;
	public static Label countryLabel;
	
	public static CheckBox productCB;
	public static CheckBox typeCB;

	public static ListBox yearLB;
	public static FlexTable fTable = new FlexTable(); // size is flexible

	public static ListBox countryLB;
	public static ListBox productLB;
	public static ListBox typeLB;

	public static Button createBtn;
	public static Label informationL; // will appear if world is selected and inform the user that he can only choose a product or a producttype but not both
	
	public static MainView main;

	
	public static int lastyear = 2011; // last year we got data
	public static int CBcounter = 0; //counter how many checkboxes are checked
	//private DataManager data;
	
	public static DataManagerServiceAsync dataManagerSvc = GWT.create(DataManagerService.class);
	/*
	 * This class is drawing the options, the user can choose from. The
	 * RootPanel is a FlexTable (Table with flexible size)
	 */
	public SelectionView_v2(MainView main){
	...
	private static class createClickHandler implements ClickHandler {
...
//this changehandler will let a label appear when world is not selected and dissapear when a country is selected
	public static class countryLBChangeHandler implements ChangeHandler{
	...
	public static class listBoxChangeHandler implements ChangeHandler {
